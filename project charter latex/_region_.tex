\message{ !name(project_charter.tex)}%%% LaTeX Template: Article/Thesis/etc. with colored headings and special fonts
%%%
...
\message{ !name(project_charter.tex) !offset(-3) }
...
\end{document}
\message{ !name(project_charter.tex) !offset(-148) }
